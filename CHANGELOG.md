...
- Nothing is changed from the user perspective,
  this is an Android 15 compatibility update enforced by Google Play
...
[Unreleased]: https://github.com/Radiokot/ln-addr-to-invoice/compare/1.4.1(8)...HEAD

[1.4.1]: https://github.com/Radiokot/ln-addr-to-invoice/compare/1.4.0(7)...1.4.1(8)
